...
export function Item({ emoji }) {
    ...
    return (
        <li className="bg-salmon py-8 px-12 rounded-3xl text-center overflow-hidden">
            ...
            <button className="bg-transparent border border-solid p-3 border-white rounded cursor-pointer w-32 text-white transition-colors duration-300 hover:text-salmon hover:bg-white "
                onClick={() => {
